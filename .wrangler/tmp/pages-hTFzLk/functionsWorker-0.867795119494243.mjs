...
// ../.wrangler/tmp/bundle-V0J9jZ/strip-cf-connecting-ip-header.js
  ...
  for (let year = startYear; year <= endYear; year++) {
    try {
      ...
      const { results: existingRows } = await context.env.DB.prepare(
        "SELECT date, name, is_leave_together FROM holidays WHERE date LIKE ? ORDER BY date ASC"
      ).bind(`${year}-%`).all();
...
// ../.wrangler/tmp/pages-hTFzLk/functionsRoutes-0.382387288629387.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-V0J9jZ/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-V0J9jZ/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.867795119494243.mjs.map
